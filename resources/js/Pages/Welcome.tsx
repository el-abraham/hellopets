...
export default function Welcome({ auth, laravelVersion, phpVersion }: PageProps<{ laravelVersion: string, phpVersion: string }>) {
  return (
    <>
      ...
      {/* <div className="relative sm:flex flex-col sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div className=''>
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni pariatur optio quia deserunt incidunt doloremque ex nobis, neque possimus mollitia. Voluptas, earum obcaecati maxime repudiandae explicabo laboriosam enim corporis quod.
        </div>
...
const ShopDisplayItem = () => {
  return (
    <a href="/shop/1">
      <div className='cursor-pointer'>
        <div className='border aspect-square rounded-lg w-full'>

        </div>
        <div className='flex justify-between items-center space-x-2 mt-2'>
          <h6 className='truncate font-semibold text-md'>Shop Shoip KUqwe wqe wqe wqe qwe qw eqw</h6>
          <span>4.5</span>
        </div>

        <p className='text-primary/80'>Lorem ipsum dolor sit amet consectetur</p>
